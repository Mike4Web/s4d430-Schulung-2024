...
define root view entity ZI_09_Flight
  as select from sflight
  composition [0..*] of ZI_09_Booking     as _Bookings
  association [1..1] to ZI_09_CarrierText as _CarrierText on $projection.CarrierID = _CarrierText.Carrid
{
